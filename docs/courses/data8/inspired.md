...
curriculum. Click a logo to open its marker on the map; click a map marker for
the institution logo and website.

<div class="inspired-map-section" markdown="0">
  <p class="inspired-map-hint"><span id="inspired-count">—</span> institutions · click a logo to locate it on the map</p>
  <div id="inspired-institution-list" class="inspired-list" aria-label="Institutions with Data 8 inspired curriculum"></div>
