...
Once you have installed the components above, we recommend you move through this [tutorial](https://otter-grader.readthedocs.io/en/v4.4.1/tutorial.html). The final step illustrates how to grade.
