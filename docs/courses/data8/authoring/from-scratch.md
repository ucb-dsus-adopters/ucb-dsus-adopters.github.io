...
**Part 1:** Setting up your environment — :material-play-circle: [Screen Recording (5 min)](https://drive.google.com/file/d/1JWs35cRRaGbtYlsVGFfFPxE3p26oqZna/view?usp=drive_link)
...
**Part 2:** Running Otter Assign — :material-play-circle: [Screen Recording (12 min)](https://drive.google.com/file/d/1UfT6zWLygEFX6rV6zUQYrzGmzHPtAoAl/view?usp=sharing)
...
**Part 3:** Distributing Notebook to Students (nbgitpuller links) — :material-play-circle: [Screen Recording (5 min)](https://drive.google.com/file/d/18vD5_SqlQ70uH5n_80qevCgx9E-PCU_k/view?usp=sharing)
...
**Part 4:** Authoring Jupyter Notebooks (without otter-grader!) — :material-play-circle: [Screen Recording (12 min)](https://drive.google.com/file/d/1HVP-PCc-pY_anBnd7kMe98eL9VZu51WD/view?usp=drive_link)
...
**Part 5:** Authoring Jupyter Notebooks with Otter-Graded Content — :material-play-circle: [Screen Recording (13 min)](https://drive.google.com/file/d/1DFjz5R9uyKyhNxq9NhYWNz1SrIYH47ao/view?usp=sharing)

This adds onto Part 4, by including examples of Markdown to create otter-graded self-check questions as well as instructor grading questions. This includes assigning points as well as exploring how we might create questions that require students to code, answer short-answer or free-form questions or respond Multiple Choice prompts. The example notebook used in this video can be viewed [in the source repository](https://github.com/ds-modules/open-data-science-courses/blob/main/adoption_courses/data8/authoring/otter-examples.ipynb).
